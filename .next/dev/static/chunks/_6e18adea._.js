...
"[project]/components/cart/data:27f249 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"7090c5325d8a0b763a0e1ca97b26ba6c6f66fab7c3":"addItem"},"components/cart/actions.ts",""] */ __turbopack_context__.s([
    "addItem",
    ()=>addItem
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$cart$2f$data$3a$27f249__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/components/cart/data:27f249 [app-client] (ecmascript) <text/javascript>");
...
function DeliveryWidget(props) {
    ...
    // Create action that will receive deliveryPrice
    const createAddItemAction = (deliveryPrice)=>{
        if (!selectedVariantId) return null;
        return formAction.bind(null, selectedVariantId, deliveryPrice);
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$6$2e$0$2d$canary$2e$60_react_60c2d962eb59e8fdc3ce5782532c32a4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DeliveryWidget.useEffect": ()=>{
            if (pickupArea && dropoffArea) {
                const fetchQuote = {
                    "DeliveryWidget.useEffect.fetchQuote": async ()=>{
                        setLoading(true);
                        setTracking(null);
                        try {
                            const res = await fetch("/api/rockets/quote", {
                ...
                }["DeliveryWidget.useEffect.fetchQuote"];
                fetchQuote();
            }
            ...
            loading && !quote ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$6$2e$0$2d$canary$2e$60_react_60c2d962eb59e8fdc3ce5782532c32a4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    finalVariant && selectedVariantId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$6$2e$0$2d$canary$2e$60_react_60c2d962eb59e8fdc3ce5782532c32a4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        action: async ()=>{
                            // Get selected delivery option price
                            const selectedDeliveryOption = quote.options.find((o)=>o.service_level === serviceLevel);
                            const deliveryPrice = selectedDeliveryOption ? Number(selectedDeliveryOption.price) : 0;
                            // Optimistic update with delivery price
                            addCartItem(finalVariant, props.product, deliveryPrice);
                            // Server action with delivery price
                            const addItemActionWithDelivery = createAddItemAction(deliveryPrice);
                            if (addItemActionWithDelivery) {
                                addItemActionWithDelivery();
                            }
                        },
                        className: "mt-2",
                        children: [
...
_s(DeliveryWidget, "BSobhbN0QTnp73oV858Lxl8xeUI=", false, function() {
    return [
...
//# sourceMappingURL=_6e18adea._.js.map