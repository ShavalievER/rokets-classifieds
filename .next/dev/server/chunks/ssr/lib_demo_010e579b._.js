...
"[project]/lib/demo/categories.ts [app-rsc] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/lib_demo_categories_ts_734f661b._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/lib/demo/categories.ts [app-rsc] (ecmascript)");
    });
});
}),
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/lib_demo_006da763._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
